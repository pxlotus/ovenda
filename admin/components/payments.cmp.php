                        ...
                        <div class="body">
                            ...
                            <div class="tab-content padding-0">
                                <div class="tab-pane table-responsive active show" id="All">
                                    ...
                                    <div style="color:red;" class="col-lg-12 text-center">
                                        <?php 
                                            if (isset($_SESSION['statusMsg'])) {
                                                echo '<span class="color-green text-center" style="text-align:center; color:green; font-size:10px;"><i class="fa fa-check-circle-o"></i> ' .
                                                    $_SESSION['statusMsg'] .
                                                    '</span>';
                                                    }

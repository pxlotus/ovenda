                            ...
                            <form action="#">
                                <div class="table-content table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail"><a href="product-details.html"><img src="<?= $url ?>static/siteassets/img/shop/product/product-1.jpg" alt=""></a></td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail"><a href="product-details.html"><img src="<?= $url ?>static/siteassets/img/shop/product/product-2.jpg" alt=""></a></td>

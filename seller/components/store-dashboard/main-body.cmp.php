                    ...
                    <div class="card top_widget primary-bg">
                        <div class="body" style="box-shadow: none;">
                            ...
                            <div class="content text-light">
                                <div class="text mb-2 text-uppercase">Total Products</div>
                                <h4 class="number mb-0">751<span class="font-12"></h4>
                                <!-- <small>Analytics for last month</small>, <i class="fa fa-level-up"></i> 8.1%</span>  -->
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card top_widget bg-dark">
                        <div class="body">
                            ...
                            <div class="content text-light">
                                <div class="text mb-2 text-uppercase">Total sales</div>
                                <h4 class="number mb-0">450<span class="font-12"><i class="fa fa-level-up"></i> 5.2%</span></h4>
                    ...
                    <div class="card top_widget secondary-bg">
                        <div class="body">
                            ...
                            <div class="content text-light">
                                ...
                                <h4 class="number mb-0">8,231,000 Ugx<span class="font-12"></h4>
                                <small>Analytics for last month</small>
                            </div>
                            <div class="sparkline text-left mt-3" data-type="bar" data-offset="100" data-width="100%" data-height="40px"
